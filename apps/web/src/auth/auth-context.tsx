...
import { getWebAuthController } from "../lib/auth-controller";
...
export function AuthProvider({ children }: AuthProviderProps) {
  const env = useMemo(() => getWebSupabaseEnv(), []);
  const controller: AuthController = useMemo(() => getWebAuthController(), []);
  const client = useMemo(() => getWebSupabaseClient(), []);
