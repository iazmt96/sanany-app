export const en = {
  ...
  marketplace: {
    ...
    create: {
      ...
      errors: {
        ...
        categoryFieldsLoading: "Loading category fields...",
        categoryFieldRequired: "Please review the field: {{field}}.",
    ...
    edit: {
      ...
      priceLabel: "Price",
      locationLabel: "Location",
      locationHint: "Pick the location from the map and the name will fill automatically.",
      mapSelectionHint: "Tap the map to place the pin where you want, then save the location.",
      ...
      errors: {
        ...
        locationResolveFailed: "Could not resolve the location name automatically. Try another point or save the current coordinates.",
    ...
    detail: {
      ...
      updatedSuccess: "Listing activity time updated.",
      ...
      editAction: "Edit",
      commissionTitle: "Listing commission",
      transferCommissionAction: "Transfer commission",
      transferCommissionHint: "Once the commission is transferred, the listing moves automatically to sold ads.",
      commissionTransferredAction: "Commission transferred",
      commissionTransferredHint: "This listing was moved to sold ads after the commission was recorded.",
  ...
  myAds: {
    ...
    saleFlow: {
      ...
      saleSources: {
        sanany_chat: "Sold through SANANY Chat",
        outside_sanany: "Sold outside SANANY",
        cancelled: "Sale cancelled",
        other: "Other"
      },
      otherSaleSourcePlaceholder: "Add a short note",
      ...
      buyerNameLabel: "Buyer name (optional)",
      buyerNamePlaceholder: "Enter buyer name",
      buyerPhoneLabel: "Buyer mobile number (optional)",
      ...
      invoiceSharePdf: "Share Invoice (PDF)",
      ...
      redirectingToTap: "Redirecting you to Tap checkout...",
      ...
      tapWebOnlyHint: "Sale details were saved and you can complete the Tap commission payment.",
      tapAuthRequired: "Your session expired. Sign in again to continue payment.",
      completeOnWebButton: "Complete payment",
      ...
      soldTabTitle: "Sales History",
      draftsTabTitle: "Drafts",
      expiredTabTitle: "Expired Ads",
      soldDate: "Sold date",
      returnToSalesHistory: "Return to Sales History",
      saleCompletedTitle: "Sale Completed Successfully",
      saleCompletedPoints: {
        markedSold: "Advertisement marked as sold.",
  ...
  admin: {
    ...
    commissionPayments: {
      ...
      analytics: {
        ...
        averageSaleAmount: "Average sale amount",
        averageCommissionAmount: "Average commission",
        averageSellingTime: "Average selling time",
        conversionRate: "Published to sold conversion",
  ...
  stories: {
    ...
    noStoriesDescription: "Follow sellers to see their stories here",
    ...
    attachedListings: "Attached Listings",
    myListings: "My Listings",
    noListingsToAttach: "No listings to attach",
    addCaption: "Add a caption...",
    addLocation: "Add location",
    typeStoryText: "Type your story here...",
    ...
    videoTooLong: "Video is longer than 30 seconds. Please choose a shorter video.",
    mediaRequired: "Please add an image, video, or text",
    publishStory: "Publish Story",
    publishing: "Publishing...",
    published: "Published",
    followToSeeStories: "Follow sellers to see their stories",
