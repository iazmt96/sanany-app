export const ar = {
  ...
  marketplace: {
    ...
    create: {
      ...
      errors: {
        ...
        categoryFieldsLoading: "جاري تحميل الحقول الخاصة بهذا التصنيف...",
        categoryFieldRequired: "يرجى مراجعة الحقل: {{field}}.",
    ...
    edit: {
      ...
      priceLabel: "السعر",
      locationLabel: "الموقع",
      locationHint: "حدد الموقع من الخريطة وسيُعبأ الاسم تلقائيًا.",
      mapSelectionHint: "اضغط على الخريطة لوضع الدبوس في المكان المطلوب، ثم احفظ الموقع.",
      ...
      errors: {
        ...
        imagesProcessing: "انتظر حتى يكتمل تجهيز الصور.",
        locationResolveFailed: "تعذر تحديد اسم الموقع تلقائيًا. يمكنك اختيار نقطة أخرى أو الحفظ بالإحداثيات الحالية.",
    ...
    detail: {
      ...
      updatedSuccess: "تم تحديث وقت الإعلان.",
      updateFailed: "تعذر تحديث الإعلان.",
      ...
      editAction: "تعديل",
      commissionTitle: "عمولة الإعلان",
      transferCommissionAction: "تحويل العمولة",
      transferCommissionHint: "إذا تم تحويل العمولة سينتقل الإعلان تلقائيًا إلى الإعلانات المباعة.",
      commissionTransferredAction: "تم تحويل العمولة",
      commissionTransferredHint: "تم نقل الإعلان إلى الإعلانات المباعة بعد تسجيل العمولة.",
  ...
  myAds: {
    ...
    saleFlow: {
      ...
      saleSources: {
        sanany_chat: "تم البيع عبر محادثات سنعني",
        outside_sanany: "تم البيع خارج سنعني",
        cancelled: "تم إلغاء البيع",
        other: "أخرى"
      },
      otherSaleSourcePlaceholder: "أضف ملاحظة قصيرة",
      ...
      youWillReceive: "المبلغ الذي ستحصل عليه",
      buyerNameLabel: "اسم المشتري (اختياري)",
      buyerNamePlaceholder: "أدخل اسم المشتري",
      buyerPhoneLabel: "جوال المشتري (اختياري)",
      ...
      invoiceSharePdf: "مشاركة الفاتورة (PDF)",
      ...
      redirectingToTap: "جاري تحويلك إلى بوابة Tap لإتمام الدفع...",
      ...
      tapWebOnlyHint: "تم حفظ بيانات البيع ويمكنك إكمال دفع العمولة عبر Tap.",
      tapAuthRequired: "انتهت جلسة تسجيل الدخول. سجّل الدخول مرة أخرى لإكمال الدفع.",
      completeOnWebButton: "إكمال الدفع",
      ...
      soldTabTitle: "سجل المبيعات",
      draftsTabTitle: "المسودات",
      expiredTabTitle: "الإعلانات المنتهية",
      soldDate: "تاريخ البيع",
      returnToSalesHistory: "العودة إلى سجل المبيعات",
      saleCompletedTitle: "✅ اكتملت عملية البيع بنجاح",
      saleCompletedPoints: {
  ...
  admin: {
    ...
    commissionPayments: {
      ...
      analytics: {
        todayRevenue: "عمولة اليوم",
        weekRevenue: "هذا الأسبوع",
        monthRevenue: "هذا الشهر",
        yearRevenue: "هذا العام",
        ...
        averageSaleAmount: "متوسط مبلغ البيع",
        averageCommissionAmount: "متوسط العمولة",
        averageSellingTime: "متوسط زمن البيع",
        conversionRate: "تحويل المنشور إلى مباع",
        topSellers: "أعلى البائعين",
  ...
  stories: {
    ...
    noStoriesDescription: "تابع بائعين لترى قصصهم هنا",
    viewStory: "عرض القصة",
    closeStory: "إغلاق",
    ...
    attachedListings: "الإعلانات المرفقة",
    myListings: "إعلاناتي",
    noListingsToAttach: "لا توجد إعلانات لإرفاقها",
    addCaption: "أضف تعليق...",
    addLocation: "إضافة موقع",
    typeStoryText: "اكتب قصتك هنا...",
    chooseMedia: "اختر صورة أو فيديو",
    uploadImage: "رفع صورة",
    uploadVideo: "رفع فيديو",
    writeText: "كتابة نص",
    storyExpires: "تنتهي بعد {{hours}} ساعة",
    storyExpired: "انتهت صلاحية هذه القصة",
    storyViews: "{{count}} مشاهدة",
    saveToHighlights: "حفظ في المميزات",
    highlights: "المميزات",
    highlightTitle: "عنوان المجموعة",
    newHighlight: "مجموعة جديدة",
    createHighlight: "إنشاء مجموعة",
    deleteStory: "حذف القصة",
    deleteStoryConfirm: "هل أنت متأكد من حذف هذه القصة؟",
    videoTooLong: "الفيديو أطول من 30 ثانية. يرجى اختيار فيديو أقصر.",
    mediaRequired: "يجب إضافة صورة أو فيديو أو نص",
    publishStory: "نشر القصة",
    publishing: "جاري النشر...",
    published: "تم النشر",
    followToSeeStories: "تابع بائعين لترى قصصهم",
